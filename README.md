...
🍜 [Case Study #1 - Danny's Diner](https://github.com/bachbaongan/Project/tree/118bd08d2351671a502a985061beabe98a5e37d9/SQL/8_week_SQL_Challenge/Case%20Study%20%232) | EDA| Analyzed customer sales data to provide actionable insights into customer spending habits, popular menu items, and the impact of a new loyalty program. Insights were used to calculate customer points and understand program effectiveness.
